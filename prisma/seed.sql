...
('prod_5', 'sp_1', 'cat_1', 'Motion Heavy Tee', 'motion-heavy-tee', 'A clean heavyweight cotton tee with a calm oversized shape and premium everyday finish.', 2490, 40, '["https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=800"]', '["oversized"]', 1, 'ACTIVE', datetime('now'), datetime('now')),
